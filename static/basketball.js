$(document).ready(function() {
    ...
    var descriptions = {
        ...
        '3': 'When the ball is with the middle offensive players, the center defender needs to be prepared to step up to challenge shots or drives to the basket, while the two wing defenders should stay alert to close out on any shooters on the perimeter.',
